...
async def optimize(request: OptimizeRequest) -> OptimizeResponse:
    try:
        return run_optimization(points=request.points, algorithm=request.algorithm, params=request.params, constraints=request.constraints, distance_mode=request.distance_mode)
