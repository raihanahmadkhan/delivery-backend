...
async def benchmark(request: BenchmarkRequest) -> BenchmarkResponse:
    try:
        return run_benchmark(points=request.points, algorithms=request.algorithms, params=request.params, constraints=request.constraints, distance_mode=request.distance_mode, n_runs=request.n_runs)
